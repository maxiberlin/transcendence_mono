export default class DrawObj {
    ...
    get offsetTop() {
        return this.parent ? this.y_start - this.parent.y_start : 0;
    }

    get offsetBottom() {
        return this.parent ? this.parent.y_end - this.y_end : 0;
    }

    get offsetLeft() {
        return this.parent ? this.x_start - this.parent.x_start : 0;
    }

    get offsetRight() {
        return this.parent ? this.parent.x_end - this.x_end : 0;
    }
    ...
    collision(obj) {
        ...
        if (diffT > 0 && diffR > 0)
            return diffT < diffR ?
                    DrawObj.COLLISION_TOP
                :   DrawObj.COLLISION_RIGHT;
        if (diffT > 0 && diffL > 0)
            return diffT < diffL ?
                    DrawObj.COLLISION_TOP
                :   DrawObj.COLLISION_LEFT;
        if (diffB > 0 && diffR > 0)
            return diffB < diffR ?
                    DrawObj.COLLISION_BOTTOM
                :   DrawObj.COLLISION_RIGHT;
        if (diffB > 0 && diffL > 0)
            return diffB < diffL ?
                    DrawObj.COLLISION_BOTTOM
