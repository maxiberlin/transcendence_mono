...
class GameCourtRemote {
    ...
    draw(ctx, colorWhite, colorBlack) {
        ...
        ctx.textAlign = "right";
        ctx.fillText(this.scoreL, this.x_center - this.bH, this.bH  + this.#textHeight);
        ctx.textAlign = "left";
        ctx.fillText(this.scoreR, this.x_center + this.bH, this.bH + this.#textHeight);
...
export class PongRemote {
    ...
    initGameObjects(gameSettings) {
        ...
        this.gamePlane = new GameCourtRemote(gameSettings.border_width, gameSettings.border_height);
        this.gamePlane.setScale(this.width, this.height);
        /** @type {DrawObjRemote} */
        this.paddleL = new DrawObjRemote(gameSettings.paddle_width, gameSettings.paddle_height, gameSettings);
        this.paddleL.setScale(this.width,  this.height);
        /** @type {DrawObjRemote} */
        this.paddleR = new DrawObjRemote(gameSettings.paddle_width, gameSettings.paddle_height, gameSettings);
        this.paddleR.setScale(this.width,  this.height);
        /** @type {DrawObjRemote} */
        this.ball = new DrawObjRemote(gameSettings.ball_width, gameSettings.ball_height, gameSettings);
