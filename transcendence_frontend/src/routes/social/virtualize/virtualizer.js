...
export class Virtualizer {
  ...
  /** @type {import('./layout/layout.js').LayoutT.MeasureChildFunction | null} */
    ...
    async _initLayout(layoutConfig: LayoutConfigValue) {
    ...
    /** @param {StateChangedMessage} state  */
    ...
    /** @param {LayoutHostMessage} message  */
    ...
    /**
     * @param {number} index 
     * @returns {VirtualizerChildElementProxy | undefined}
     */
    element(index) {
        if (index === Infinity) {
    ...
    /** @param {ScrollElementIntoViewOptions} options  */
