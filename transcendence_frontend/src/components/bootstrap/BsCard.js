...
export const renderListCard = (title, icon, listItems) => {
    ...
    return html`
        <div class="card">
            ${title ? html`
                <h6 class="my-2 card-title">${icon ? html`<i class="fa-solid fa-scroll m-2">` : ""}</i>${title}</h6>
            ` : ""}
            <div class="card-body">
...
export const renderCardInfo = (title, content) => {
    return html`
        <p class="text-body-secondary p-0 m-0"> ${title} <br> <span class="text-body"> ${content} </span> </p>
    `
}
...
export class BsCard extends BaseElem {
    ...
    render() {
        return html`
            <div class="card">
                ${this.header ? html`
                <div class="card-header">
                    <h6 class="">${this.icon ? html`<i class="fa-solid fa-${this.icon}"></i>` : ""} ${this.header}</h6>
                </div>` : ""}
                <div class="card-body">
