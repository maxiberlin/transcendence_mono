...
export const actions = {
    /** @param {number} userId        @param {ActionBtnData} conf */
    ...
    /** @param {number} requestId     @param {ActionBtnData} conf */
    ...
    /** @param {number} invitationId  @param {ActionBtnData} conf */
    ...
    acceptGameInvitation: (invitationId, conf) =>
        getBtn(
            sessionService.acceptGameInvitation.bind(
                sessionService,
                invitationId,
            ),
            conf,
    ...
    rejectGameInvitation: (invitationId, conf) =>
        getBtn(
            sessionService.rejectGameInvitation.bind(
                sessionService,
                invitationId,
            ),
            conf,
    ...
    /** @param {number} scheduleId    @param {ActionBtnData} conf */
    startGame: (scheduleId, conf) =>
        getBtn(
            sessionService.startGameByScheduleId.bind(
                sessionService,
                scheduleId,
            ),
            conf,
