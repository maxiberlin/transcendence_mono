...
#     curr = UserAccount.objects.get(pk=user_id)
#     friendlist = FriendList.objects.get(user=curr)
#     friends = friendlist.friends.all()
#     for friend in friends:
#         f: UserAccount = friend
#         room = get_private_room_or_create(curr, f)
#         print(f"user: {curr}: friend: {f}: room created: {room}")
