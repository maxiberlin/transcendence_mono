...
class PlayerConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        try:
            ...
            pong_game: PongGame = await sync_to_async(self.game_manager.get_game)(self.room_group_name)
            if not pong_game:
    ...
    async def cleanup_game_data(self):
        try:
            await sync_to_async(self.game_manager.stop_game)(self.room_group_name)  # Lösche die Spieldaten
