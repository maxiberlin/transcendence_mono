...
from other_chat.models import OtherChatParticipation, OtherChatConversation, OtherChatMessageData, OtherChatConversationData
...
class CommandResponseDataGetConversationMessages(TypedDict):
    conversation_ident: str
    messages: list[OtherChatMessageData] | None
    next_page: int
